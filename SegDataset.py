...
def read_file_list(type='train'):
    ...
    images_val = [os.path.join(r"datasets/images_train", i) for i in path_list_images_val]
    labels_val = [os.path.join(r"datasets/labels_train", i) for i in path_list_labels_val]
